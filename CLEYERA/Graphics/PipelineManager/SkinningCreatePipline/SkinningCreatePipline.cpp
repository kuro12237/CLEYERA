#include "SkinningCreatePipline.h"

SPSOProperty SkinningCreatePipline::CreateSkinningPhongModel(ComPtr<ID3D12Device> device, Commands commands, SShaderMode shader)
{
	SPSOProperty pso;
	CreateSkinningPhongRootSignature(device, pso);
   ...
   device->CreateGraphicsPipelineState(&graphicsPipelineStateDesc,
