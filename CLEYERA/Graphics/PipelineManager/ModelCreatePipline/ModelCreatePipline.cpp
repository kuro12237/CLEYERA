...
SPSOProperty ModelCreatePipline::CreateSkyBoxxPhongSkinnningModel(ComPtr<ID3D12Device> device, Commands commands, SShaderMode shader)
{
	SPSOProperty pso;
	...
	//skyBox
	D3D12_DESCRIPTOR_RANGE descriptorRangeSkyBox[1] = {};
	descriptorRangeSkyBox[0].BaseShaderRegister = 4;
	descriptorRangeSkyBox[0].NumDescriptors = 1;
	descriptorRangeSkyBox[0].RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
	descriptorRangeSkyBox[0].OffsetInDescriptorsFromTableStart = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND;

	rootParameters[9].ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE;
	rootParameters[9].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL;
	rootParameters[9].DescriptorTable.pDescriptorRanges = descriptorRangeSkyBox;
	rootParameters[9].DescriptorTable.NumDescriptorRanges = _countof(descriptorRangeSkyBox);
