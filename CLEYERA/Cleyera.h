...
public:
	...
	void TriangleDraw(Vector4 top, Vector4 left, Vector4 right, BufferResource vertex);
	...
	/// <param name="右下"></param>
	/// <param name="vertex"></param>
	void RectDraw(Vector4 lefttop, Vector4 righttop, Vector4 leftdown, Vector4 rightDown, RectBufferResource vertex);
