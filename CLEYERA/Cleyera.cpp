...
/// <param name="vertex"></param>
void Cleyera::TriangleDraw(Vec4 top, Vec4 left, Vec4 right, BufferResource vertex)
{
...
/// <param name="右下"></param>
/// <param name="vertex"></param>
void Cleyera::RectDraw(Vec4 leftTop, Vec4 rightTop, Vec4 leftDown, Vec4 rightDown, RectBufferResource vertex)
{
